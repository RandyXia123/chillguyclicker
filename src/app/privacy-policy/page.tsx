  ...
  return (
    <main className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="bg-white/10 rounded-lg p-8 shadow-xl">
        ...
        {/* Introduction */}
        <div className="text-gray-200 mb-8 leading-relaxed">
          <p>
            Chill Guy Clicker is committed to protecting the privacy of all visitors who use our site 
        ...
        <div className="space-y-8">
          ...
          >
            <p>
            All features on the Chill Guy Clicker Site are available without the need for registration by Users. No personal data (such as email addresses and phone numbers) are requested from users. Chill Guy Clicker may collect certain electronic data (such as the User's IP address, cookies or device ID).When a User clicks to leave the Chill Guy Clicker Kids Site, Chill Guy Clicker may try to inform the User that they are leaving the Chill Guy Clicker Kids Site and that this Privacy Policy will no longer apply. When a User provides personal data on any third party website or application, the processing of such personal data will be governed by any privacy statement applicable to that site/application. In any event, Chill Guy Clicker shall not act as the Data Controller or the Processor of such personal data.
            </p>
          </Section>
          ...
          >
            <p>
            Data collection and its purposes Our servers automatically recognize visitors' domain names and IP addresses (the number assigned to computers on the Internet). The Chill Guy Clicker Site may gather anonymous "traffic data" that does not personally identify you, but that data may be helpful for marketing purposes or for improving the services we offer.When your computer or mobile device contacts our web servers (for example, when you visit the Chill Guy Clicker Site), our web servers automatically collect usage information. Such usage information includes information about how our visitors use and navigate the Chill Guy Clicker Site. It can include the number and frequency of visitors to each web page and the length of their stays, browser type, and referrer data that identifies the web page visited prior and subsequent to visiting our Site.Traffic information may also be shared with business partners and advertisers on an aggregate and anonymous basis. More information about sharing information will follow in part 7.In addition, Advertisers on the Chill Guy Clicker General Site might receive information gathered by cookies for targeted advertising purposes. Further information regarding the use of cookies can be found below.
            Data collection and its purposes Our servers automatically recognize visitors’ domain names and IP addresses (the number assigned to computers on the Internet). The Chill Guy Clicker Site may gather anonymous “traffic data" that does not personally identify you, but that data may be helpful for marketing purposes or for improving the services we offer.When your computer or mobile device contacts our web servers (for example, when you visit the Chill Guy Clicker Site), our web servers automatically collect usage information. Such usage information includes information about how our visitors use and navigate the Chill Guy Clicker Site. It can include the number and frequency of visitors to each web page and the length of their stays, browser type, and referrer data that identifies the web page visited prior and subsequent to visiting our Site.Traffic information may also be shared with business partners and advertisers on an aggregate and anonymous basis. More information about sharing information will follow in part 7.In addition, Advertisers on the Chill Guy Clicker General Site might receive information gathered by cookies for targeted advertising purposes. Further information regarding the use of cookies can be found below.
            </p>
          </Section>
          ...
          >
            <p>
            Chill Guy Clicker may retain users’ data for the following purposes:To develop new features and improve the Chill Guy Clicker Site;To support subsequent customer service inquiries;To improve the safety and security of the Chill Guy Clicker Site; orComply with our legal obligations.We will retain your information for as long as is reasonably necessary in relation to the purposes for which this data was collected.
            </p>
          </Section>
          ...
          >
            <p>
            This Privacy Policy does not apply to the processing of personal data by data controllers other than Chill Guy Clicker , such as providers of third party games available on the Chill Guy Clicker Site. The relevant provider of such a third party game is responsible for ensuring that any processing of personal data by them in the context of a game complies with applicable data protection laws.Generally, Chill Guy Clicker does not permit third party content providers to collect personal data about Users. However, if any personal data will be collected by a third party content provider, Chill Guy Clicker will contractually require that the processing of personal data by them in the context of a game complies with applicable data protection laws.
            </p>
          </Section>
          ...
          >
            <p>
            The Chill Guy Clicker General Site knowingly links out to the following third party websites. The names of these third party websites link to their privacy policy.YouTubeFacebookInstagramWhatsappTwitterKikSome of the third party games published on the Chill Guy Clicker General Site and Chill Guy Clicker Kids Site do link out to third party websites. Chill Guy Clicker uses technology and people to monitor these links for inappropriate content but it does not have full control over the third party games on the Chill Guy Clicker Site.
            </p>
          </Section>
          ...
          >
            <p>
            Chill Guy Clicker may share your persistent identifiers with third parties such as business partners under the following circumstances:Security: We may release information about our Users, including IP address, when legally required to do so, at the request of governmental authorities conducting an investigation or to verify or enforce compliance with the policies governing the Chill Guy Clicker Site and applicable laws. We may also disclose such user information whenever we believe disclosure is necessary to protect the rights, property or safety of Chill Guy Clicker , or any of our respective business partners, customers or others.Aggregate Information: We may disclose non-identifying, aggregated user statistics to third parties for a variety of purposes, including describing our services to prospective partners and other third parties. Examples of such non-personal information include the number of users who visited this Chill Guy Clicker Site during a specific time period or played a specific game on this Website.Advertising: We may share technical information such as IP address or device ID with our advertising partners. For advertising on the Chill Guy Clicker General Site, this information may be used to serve behaviorally targeted ads or profiling. For advertising on the Chill Guy Clicker Kids Site, this information will only be shared for the purposes of serving contextual advertising and capping the frequency of ads.
            </p>
          </Section>
          ...
          >
            <p>
           We recognize the importance of safeguarding the privacy of children and encourage parents to check and monitor their children’s use of online activities regularly. This is why we created a separate age-appropriate experience for Children Users through the Chill Guy Clicker Kids Site, or through an age-gate in certain games on the Chill Guy Clicker General Site: in order to comply with the legislation, you could be presented to an age screen when starting the game. When presented with this age screen, it is important that you state the correct age. Based on your age information and your device settings, Chill Guy Clicker does not process personal data of children under the minimum age limit (Children Users) that is prescribed by the legislation in the individual jurisdictions for behavioral advertisement.The Children Users’ experience of games with an age-gate on the Chill Guy Clicker General Site, and the Chill Guy Clicker Kids Site supports and complies with the Children’s Online Privacy Protection Act (“COPPA"). The Children Users’ experience of games with an age-gate on the Chill Guy Clicker General Site and the Chill Guy Clicker Kids site will not request any personal information from Children Users. There is no registration required for the Chill Guy Clicker Kids Site and any advertising shown on the Chill Guy Clicker Kids Site, or in the the Children Users’ experience of games with an age-gate on the Chill Guy Clicker General Site, is age-appropriate. The Chill Guy Clicker Kids Site and the Children Users’ experience of games with an age-gate on the Chill Guy Clicker General Site will not show behaviorally targeted ads or allow third parties to track the activity of Children Users for that purpose.The Chill Guy Clicker Kids Site and the the Children Users’ experience of games with an age-gate on the Chill Guy Clicker General Site may collect and use IP addresses and other persistent identifiers, including cookies, from Children Users, but only for purposes of supporting our internal operations, such as to help us: Identify whether you are a child or adult for data protection purposes to determine the legal requirements for our processing of your dataMaintain or analyze the functioning of the Chill Guy Clicker Kids SitePerform network communicationsAuthenticate users of, or personalize the content on, the Chill Guy Clicker Kids SiteServe contextual advertising on the Chill Guy Clicker Kids Site and cap the frequency of advertisingWe have separated our platform into a few sections. Chill Guy Clicker Kids was created for our youngest audience and is fully COPPA compliant. If you are a Child User, you should only use the Chill Guy Clicker Kids Site and only with the permission of a parent or legal guardian. On Chill Guy Clicker .com, you’ll find games that are intended at users that are over 13. Chill Guy Clicker .com is not targeted towards children under the age of 13 and it will not knowingly collect personal information from children under 13.To learn more about COPPA, please reference this simple one-page informational guide from the kidSAFE Seal Program: https://www.kidsafeseal.com/knowaboutcoppa.html.
            </p>
          </Section>
